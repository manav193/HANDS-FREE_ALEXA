...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>jtransforms</b> with <b>com.github.wendykierp:JTransforms</b> coordinates and
     * with version reference <b>jtransforms</b>
     * <p>
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getJtransforms() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("jtransforms");
    }
     ...
     */
    @Deprecated
    public static class OnnxruntimeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public OnnxruntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>onnxruntime</b> with <b>com.microsoft.onnxruntime:onnxruntime</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("onnxruntime");
        }

        /**
         * Dependency provider for <b>native</b> with <b>com.microsoft.onnxruntime:onnxruntime-native</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getNative() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("onnxruntime.native");
        }
    ...
    public static class TensorflowLiteLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final TensorflowLiteMetadataLibraryAccessors laccForTensorflowLiteMetadataLibraryAccessors = new TensorflowLiteMetadataLibraryAccessors(owner);
        ...
        /**
         * Dependency provider for <b>v2140</b> with <b>org.tensorflow:tensorflow-lite</b> coordinates and
         * with version reference <b>tensorflowLiteVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV2140() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.v2140");
        }

        /**
         * Group of libraries at <b>tensorflow.lite.metadata</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TensorflowLiteMetadataLibraryAccessors getMetadata() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTensorflowLiteMetadataLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TensorflowLiteMetadataLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public TensorflowLiteMetadataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v043</b> with <b>org.tensorflow:tensorflow-lite-metadata</b> coordinates and
         * with version reference <b>tensorflowLiteMetadataVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV043() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.metadata.v043");
        }
    ...
    public static class TensorflowLiteSupportLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v043</b> with <b>org.tensorflow:tensorflow-lite-support</b> coordinates and
         * with version reference <b>tensorflowTensorflowLiteSupport</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getV043() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.support.v043");
        }

        /**
         * Dependency provider for <b>v050</b> with <b>org.tensorflow:tensorflow-lite-support</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV050() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.support.v050");
        }
    ...
    public static class TensorflowLiteTaskLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>text</b> with <b>org.tensorflow:tensorflow-lite-task-text</b> coordinates and
         * with version reference <b>tensorflowLiteTaskText</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getText() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.task.text");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jtransforms</b> with value <b>3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJtransforms() { return getVersion("jtransforms"); }
        ...
        /**
         * Version alias <b>kotlinxCoroutinesAndroid</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteGpu</b> with value <b>2.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteMetadataVersion</b> with value <b>0.4.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTensorflowLiteMetadataVersion() { return getVersion("tensorflowLiteMetadataVersion"); }
        ...
        /**
         * Version alias <b>tensorflowLiteSupportVersion</b> with value <b>0.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteTaskAudio</b> with value <b>0.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteTaskText</b> with value <b>0.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTensorflowLiteTaskText() { return getVersion("tensorflowLiteTaskText"); }

        /**
         * Version alias <b>tensorflowLiteTaskVision</b> with value <b>0.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteVersion</b> with value <b>2.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTensorflowLiteVersion() { return getVersion("tensorflowLiteVersion"); }

        /**
         * Version alias <b>tensorflowTensorflowLiteSupport</b> with value <b>0.4.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTensorflowTensorflowLiteSupport() { return getVersion("tensorflowTensorflowLiteSupport"); }
